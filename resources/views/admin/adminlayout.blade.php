...
<head>
  ...
  <script src="https://cdn.tiny.cloud/1/4ziva2f75izwx9wgyhqlptu029wce9b1dts0qh488tjjhb1g/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="\adminhome">
        <div class="sidebar-brand-icon" style="margin-top: 11px;">
          <h4 style="font-weight: bolder;">CBS</h4>
        </div>
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item active">
        <a class="nav-link" href="{{url('/cmtlist')}}">
          <i class="fas fa-comments"></i>
          <span>Comment List</span></a>
      </li>
